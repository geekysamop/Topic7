...
mongoose.connect('mongodb+srv://Samarth:Samarth123@atlascluster.lxuiwh6.mongodb.net/mydb', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.post('/send-command', (req, res) => {
    ...
    const topic = `/2110994773/command/${deviceId}`;
